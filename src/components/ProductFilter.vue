            ...
            <ul class="colors">
              <li class="colors__item" v-for="color in colors" :key="color.id">
                <label class="colors__label">
                  ...
                  <span class="colors__value" :style="{'background-color': color.colorH}">
                  </span>
                </label>
              </li>
            </ul>
...
export default {
    ...
    methods: {
        ...
        loadCategories(){
          axios.get(`https://vue-study.skillbox.cc/api/products?categoryId=${this.categoryId}`)
          .then(response => this.categoriesData = response.data); 
        },
        loadColors(){
          axios.get(`https://vue-study.skillbox.cc/api/products?colorId=${this.colorId}`)
